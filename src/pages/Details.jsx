            ...
            <div className="w-full max-w-5xl p-10">
                ...
                <div className="flex justify-between items-center mb-10">
                    <div>
                        ...
                        <a
                            href="#"
                            className="text-[var(--color-placeholder-dark)] underline text-sm font-medium"
                        >
                            By Mehmet
                        </a>
                    </div>
                ...
                <div className="text-slate-500 mb-10 max-w-3xl">
                    I've been a product manager at Google and Facebook, now I'm
                    a Partner at a venture capital firm. I can help you with
                    product strategy, roadmap planning, and career advice.
                </div>

                {/* Reputation */}
                <div className="mb-10">
                    <div className="font-bold dark:text-white mb-3">
                        Reputation
                    </div>
                    <div className="flex gap-6">
                        <div className="flex-1 bg-[var(--color-secondary)] dark:bg-[var(--color-secondary-dark)] rounded-xl p-6 flex flex-col items-center">
                            ...
                            <span className="text-[var(--color-placeholder-dark)] text-md">
                                Average Rating
                            </span>
                        </div>
                        <div className="flex-1 bg-[var(--color-secondary)] dark:bg-[var(--color-secondary-dark)] rounded-xl p-6 flex flex-col items-center">
                            <span className="text-3xl font-bold dark:text-white mb-1">
                                10
                            </span>
                            <span className="text-[var(--color-placeholder-dark)] text-md">
                                Reviews
                ...
                {/* Available Hours */}
                <div className="font-bold dark:text-white mb-4">
                    Available Hours
                </div>
                        ...
                        >
                            <div className="flex items-center gap-3 flex-1">
                                ...
                                <div>
                                    ...
                                    <div className="text-[var(--color-placeholder-dark)] text-sm">
                                        {item.label}
                                    </div>
                                </div>
                            </div>
