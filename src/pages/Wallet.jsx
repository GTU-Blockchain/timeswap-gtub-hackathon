                ...
                <div className="space-y-4 mt-6">
                    <div className="border-2 dark:border-purple-100/50 border-purple-900/50 min-h-16 min-w-5xl py-4 px-6 rounded-xl flex justify-between items-center">
                        <div>
                            ...
                            <p className="dark:text-white/50 text-black/50 font-bold">
                                Trade TIME for other skills, or other skills for
                                TIME
                            </p>
                        </div>
                        <Link
                            to="/create"
                            className="rounded-xl bg-[var(--color-primary)] px-3 py-0 hover:-translate-y-0.5 transition-all active:scale-[0.97] duration-100 hover:scale-[1.03] text-white flex justify-center items-center text-sm font-bold  w-30 h-10"
                        >
                            Offer Skill
                        </Link>
                    </div>
                    ...
                    <div className="border-2 dark:border-purple-100/50 border-purple-900/50 min-h-16 min-w-5xl py-4 px-6 rounded-xl flex justify-between items-center">
                        <div>
                            ...
                            <p className="dark:text-white/50 text-black/50 font-bold">
                                Trade TIME for a skill, or offer a skill for
                                TIME.
                            </p>
                        </div>
                        <Link
