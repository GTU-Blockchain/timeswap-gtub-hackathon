            ...
            <div className="rounded-3xl w-full max-w-5xl p-10">
                ...
                <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex gap-3">
                        <Link
                            to={`/profile/${address}/comments`}
                            className="bg-[var(--color-secondary)] dark:bg-[var(--color-secondary-dark)] text-black dark:text-white px-4 py-2 rounded-lg font-medium hover:cursor-pointer hover:scale-105 transition-transform duration-200"
                        >
                            Comment
                        </Link>
                        <Link
